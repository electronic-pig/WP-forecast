	...
	<div>
		<div class="main">
			...
			<div class="switch" id="switch-cnt">
				...
				<div class="switch_container switch_container--hidden" id="switch-c2">
...
export default {
	mounted() {
		this.initializeSwitchFunctionality();
	},
	methods: {
		initializeSwitchFunctionality() {
			...
			let getButtons = () => event.preventDefault(); // Removed unused 'e' parameter
