<template>
    <div class="container">
        ...
        <el-table :data="alarmItems.slice((currentPage - 1) * pageSize, currentPage * pageSize)"
            ...
            <el-table-column label="报警时间" width="185" sortable
            ...
            <el-table-column label="报警类型" width="110" sortable
                :sort-method="(a, b) => { return a.alarmType.localeCompare(b.alarmType) }">
            ...
            <el-table-column label="报警级别" width="110" sortable :sort-method="(a, b) => { return a.alarmLevel - b.alarmLevel }">

                <template #default="item">
                    <el-tag
                        :type="alarmLevelColor[alarmLevelMeaning[item.row.alarmLevel]]">{{ alarmLevelMeaning[item.row.alarmLevel] }}</el-tag>
                </template>

            </el-table-column>

            <el-table-column label="报警描述" width="140">
            ...
            <el-table-column label="处理时间" width="185" sortable
                :sort-method="(a, b) => { return a.processTime.localeCompare(b.processTime) }">
            ...
            <el-table-column label="处理人" width="100" sortable
                :sort-method="(a, b) => { return a.processPerson.localeCompare(b.processPerson) }">
            ...
            <el-table-column label="处理方式" width="170">
            ...
            <el-table-column label="处理结果" width="110" sortable
    ...
    computed: {
        totalPage() {
            if (this.alarmItems.length % this.pageSize != 0) {
                console.log(Math.trunc(this.alarmItems.length / this.pageSize))
