<template>
  <el-menu class="el-menu-vertical-demo" :collapse="isCollapse" text-color="black" background-color="#FFFFF"
    :default-active="activeIndex" active-text-color="#FFFFFF">
    <div class="platform">
      <img class="platform-logo" :src="require('@/assets/image/logo/logo.png')" alt="logo" @click="goDetectChanges">
      <div v-if="!isCollapse" id="platform-title">
        <a class="platform-title" @click="goShow">龙源风电功率预测平台</a>
      </div>
    </div>
